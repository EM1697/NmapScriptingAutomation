...
for(let com in commands)
{
    ...
    exec(`sudo nmap -Pn ${commands[com].command} -iL aplicativos.txt -oN /home/em16/Documents/IntrusiveApps/${commands[com].name}.txt -oX /home/em16/Documents/IntrusiveApps/${commands[com].name}.xml`,
    (e, stdout, stderr) => {
        if (e) console.log(`ERROR: ${e.message}`);
