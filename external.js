...
for(let site in sites)
{
    ...
    {
        exec(`sudo nmap -Pn ${commands[com].command} ${sites[site]} -oN /home/em16/Documents/ExternalPort/${sites[site]}-${commands[com].name}.txt -oX /home/em16/Documents/ExternalPort/${sites[site]}-${commands[com].name}.xml`,
        (e, stdout, stderr) => {
