...
for(let com in commands)
    {
        ...
        exec(`sudo nmap -Pn ${commands[com].command} -iL portales.txt -oN /home/em16/Documents/FuzzerPort/${commands[com].name}.txt -oX /home/em16/Documents/FuzzerPort/${commands[com].name}.xml`,
        (e, stdout, stderr) => {
            if (e) console.log(`ERROR: ${e.message}`);
